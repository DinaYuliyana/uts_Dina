<div align='center'>
<span style="font-size:24px;">Pekiraan Kondisi Cuaca di Demak</span>
<br>
<br>
<?php
  $json_string = file_get_contents("http://api.wunderground.com/api/14252955f15867ff/conditions/forecast/q/IA/Demak.json");
  ...
  echo " 
  Perkiraan cuaca di Demak pukul ${jam} pada tanggal ${day} ${month} ${year} adalah ${weather}<br>
