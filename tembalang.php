<div align='center'>
<span style="font-size:24px;">Pekiraan Kondisi Cuaca di Tembalang</span>
<br>
<br>
<?php
  $json_string = file_get_contents("http://api.wunderground.com/api/14252955f15867ff/conditions/forecast/q/IA/tembalang.json");
  ...
  echo " 
  Perkiraan cuaca di Tembalang pukul ${jam} pada tanggal ${day} ${month} ${year} adalah ${weather}<br>
